...
| `addressLabelSearch` | —                    | Composed                                           | `composeSearchLabel()` expands abbreviations using `flat_type_name`, `level_type_name`, `street_type_name`, `street_suffix_name`, plus `number_first`, `number_last`, `lot_number`, `street_name`, `locality_name`, `state`, `postcode` |
...
| `streetType`         | `street_type_name`   | `raw_gnaf_202602.street_type_aut.name`             | Joined via `ap.street_type`; null-coalesce                                                                                                                                                                                              |
| `streetSuffix`       | `street_suffix_name` | `raw_gnaf_202602.street_suffix_aut.name`           | Joined via `ap.street_suffix`; null-coalesce                                                                                                                                                                                            |
...
5. `street_name` + `street_type_name` + `street_suffix_name` (space-joined, nulls filtered)
