...
| `latitude`     | number   | No       | WGS84 latitude of locality centroid                | `-37.7998`                     | `gnaf.localities.latitude`                      |
| `longitude`    | number   | No       | WGS84 longitude of locality centroid               | `144.8991`                     | `gnaf.localities.longitude`                     |
