...
// Re-implement composition helpers for testing (they're not exported from flatten.ts)
// This mirrors the logic in src/flatten.ts — if the logic changes, update these tests too.
...
function composeDocument(row: Record<string, unknown>, version: string) {
